  ...
  return (
    <div className="relative h-dvh w-screen overflow-x-hidden">
      ...
      >
        ...
        <h1 className="absolute uppercase font-black text-5xl sm:right-10 sm:text-7xl md:text-9xl lg:text-[12rem] bottom-5 right-5 z-40 text-blue-400">
          Unbound
        </h1>

        <div className="absolute left-0 top-0 z-40 size-full">
          <div className="mt-24 px-5 sm:px-10">
            <h1 className="uppercase font-black text-5xl sm:right-10 sm:text-7xl md:text-9xl lg:text-[12rem] text-blue-400">
              Worlds
            </h1>

            <p className="mb-5 max-w-64 text-blue-100">
              Explore vibrant, breathing worlds <br /> of pure animated
              adventures
            </p>
            <Button
              id="watch-trailer"
      ...
      <h1 className="absolute uppercase font-black text-5xl sm:right-10 sm:text-7xl md:text-9xl lg:text-[12rem] bottom-5 right-5 text-black">
        Unbound
      </h1>
    </div>
  );
